...
class ShellExecutorTool(BaseTool):
    """
    A CrewAI tool for executing shell commands
    ...
    def _run(
        ...
        """
        Execute a shell command with comprehensive
            ...
            try:
                ...
                try:
                    ...
                    if process.returncode == 0:
                        return stdout.strip() or "Command successful."
                    else:
...
if __name__ == "__main__":
    ...
    print(shell_tool._run("python -c 'print(\"Hello from subprocess!\")'"))
